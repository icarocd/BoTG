...
public interface LabeledMeasurableGraph extends MeasurableGraph, Graph<String, LabeledWeightedEdge> {
    ...
    void convertTFtoTFIDF(int nDocuments, GraphDatasetStats stats);

    boolean prune(Collection<String> termsToPrune, boolean reconnectOrphanEdges);

    boolean pruneWorstWeightedTerms(int maxNodesToRetain);
}
